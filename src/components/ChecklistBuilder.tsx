  ...
  return (
    <div className="modalBackdrop" role="presentation">
      <section className="builder" role="dialog" aria-modal="true" aria-labelledby="builder-title">
        <div className="builderHeader"><div><p className="eyebrow">NOVO FLUXO</p><h2 id="builder-title">Criar checklist</h2></div><button className="closeButton" onClick={() => setOpen(false)} aria-label="Fechar">×</button></div>
